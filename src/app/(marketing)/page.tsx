    ...
    <div className="flex flex-col ">
      ...
      <div className="flex flex-col py-2 px-[12%]">
        ...
        <div className="container flex flex-row justify-between my-20">
          ...
          <div className="">
            <div className="mb-12">
              ...
              >
                Don&apos;t just hope your <br /> clients are <b className="text-primary italic">happy</b>.
              </h1>
              <h1
              className="text-5xl font-bold"
              >
                <b className="text-primary italic">Measure</b> it!
              </h1>
            </div>

            <h3 className="font-500">Unlock client insights. Fuel your law firms growth <br /> with actionable data.</h3>
          ...
          {/* blank for now */}
          <div className="">
            Put picture of the dashboard here*
          </div>
        ...
        <div className="flex justify-center my-20">
          <h1 className="font-bold text-4xl">Why Happy Client?</h1>
        </div>

        {/* Features */}
        <section id="features" className="my-20 container space-y-6 py-8 dark:bg-transparent md:py-12 lg:py-24">
          ...
          <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
            <div className="relative overflow-hidden rounded-lg border bg-background p-2">
              <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                ...
                <div className="space-y-2">
                  <h3 className="font-bold">Unlimited Forms/Responses</h3>
            ...
            <div className="relative overflow-hidden rounded-lg border bg-background p-2">
              <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                ...
                <div className="space-y-2">
                  <h3 className="font-bold">Unlimited Users</h3>
                  <p className="text-sm">
